...
train_dataloader = DataLoader(train_dataset, batch_size=bs, shuffle=True, num_workers=n_workers)
...
test_dataloader = DataLoader(test_dataset, batch_size=bs, num_workers=n_workers)

# Train
curves = train(model, train_loader, val_loader, criterion, optimizer, 30,
               SAVE_BEST, SAVE_CKPT, val_each=1, print_each=1)